...
// This is cheating because I am loading up so many items but the view is only giving me one.
$factory  = JContentFactory::getInstance();
			echo '<h1>'. $this->data->title . '</h1>';
			echo $this->data->body;

			echo '<div class="gallery-col-1">';
		...
		foreach ($list1 as $i )
		{
			...
			echo '<div class="image"><a href="index.php?type=image&content_id='.$i.'">
			<img src="'.$images->image_intro.'" alt="'.$images->image_intro_alt . '"></a></div><div class="clear"></div>';
		}
		echo '</div>';

		echo '<div class="gallery-col-2">';
